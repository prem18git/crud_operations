<?php
    ...
    if (isset($_GET['edit'])) {
        ...
        $id = $_GET['edit'];
        $query = mysqli_query($connect,"Select id,name,username,password,email,phone,adress from student where id = $id ");
    ...
    if (isset($_POST['update'])) {
		...
		$sql = "update student set name = '".$name."', username = '".$username."', password = '".$password."', email = '".$email."',phone = '".$phone."',adress = '".$address."' where id = '".$id."' ";
